	...
	<div class="container">
        <div class="row">
            ...
            @include('users.auth.alert')
                    ...
                    <form  method="POST" action="{{ route('user.register.store') }}" class="login_form ">
                    @csrf
                    ...
                    <div class="form-group mt-6 mb-6">
                        <button type="submit" class="btn btn-default btn-radius w-100" value="Register">Register</button>
                    </div>

                </form>
                    <div class="text-center">
                        <p>Already have an account ? <a href="{{ route('user.login') }}" style="color: #800020">Sign In</a></p>
                    </div>
